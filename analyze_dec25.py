#!/usr/bin/env python3
"""
Analyze Dec-25 Batch - All 5 students (Senthil, Aman, Praveena, Thameem, Kapil)
Exams: Week 1 (June 21st) and Week 2 (Jun 28th)
Usage: python3 analyze_dec25.py
"""
...
def analyze_batch(batch_key='dec25_batch'):
    """Analyze entire Dec-25 batch."""
    ...
    for exam in batch['exams']:
        ...
        if missing_files:
            ...
            for missing in missing_files:
                print(f"   - {missing}")
            print(f"\n   Please copy student answer files to: answers/dec25_batch/")
            continue
    ...
    print(f"\n{'='*80}")
    print(f"✓ DEC-25 BATCH ANALYSIS COMPLETE")
    print(f"{'='*80}")
    print(f"\nResults saved to: reports/dec25_results/")
    ...
    print(f"  - Thameem")
    print(f"  - Kapil")
    print(f"Class report: CISSP_Class_Analysis.xlsx\n")
    return True

if __name__ == '__main__':
    success = analyze_batch('dec25_batch')
