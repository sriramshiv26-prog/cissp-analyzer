...
def sample_cohort():
    ...
    for name, score in zip(names, scores):
        perf = StudentPerformance(
            ...
            by_domain={'Domain 5': {'correct': 15, 'wrong': 5, 'total': 20, 'percentage': 75.0}},
            by_topic={'Kerberos': {'correct': 5, 'wrong': 3, 'total': 8, 'percentage': 62.5}},
            by_difficulty={'Easy': {'correct': 20, 'wrong': 1, 'total': 21, 'percentage': 95.2}},
            by_question_type={'Scenario': {'correct': 30, 'wrong': 10, 'total': 40, 'percentage': 75.0}},
